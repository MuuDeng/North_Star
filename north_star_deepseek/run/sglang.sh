...
bash -c 'time /home/users/industry/ai-hpc/apacsc34/nsight-systems-2025.5.1/bin/nsys profile \
--output=${HOME}/scratch/nattanon/profiling/nsys_reports/sglang_profile.${PBS_JOBID}.${OMPI_COMM_WORLD_RANK} \
--trace=cuda,nvtx,mpi,osrt \
${HOME}/scratch/nattanon/py312/bin/python3 \
